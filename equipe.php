        ...
        <div class="row com-borda mt-3">
                ...
                <div class="col-3">
                    <div class="card border-none card-equipe">
                      <p class="text-center mb-0"> <img src="https://sbcf.fr/wp-content/uploads/2018/03/sbcf-default-avatar.png" class="card-img-top" alt="avatar"> </p>
                        <div class="card-body">
                            <h5 class="card-title text-center">Nome Sobrenome</h5>
